...
(function() {
  ...
  NodeType = __webpack_require__(751);
...
if (!Object.keys) {
	...
	var isArgs = __webpack_require__(866); // eslint-disable-line global-require
...
const isRecordsEvent = (item) => item.Records !== null && item.Records !== undefined;
exports.getOutput = (bucket, key, target) => __awaiter(void 0, void 0, void 0, function* () {
    var e_1, _a;
    var _b;
    const s3 = new S3();
    const query = `SELECT s.outputs['${target}']['value'] FROM S3Object s LIMIT 1`;
    const input = {
        Bucket: bucket,
        Key: key,
        Expression: query,
    ...
    const response = yield s3.selectObjectContent(input).promise();
    let data = null;
    try {
        for (var _c = __asyncValues(response.Payload), _d; _d = yield _c.next(), !_d.done;) {
    ...
    return (_b = JSON.parse(data)) === null || _b === void 0 ? void 0 : _b.value;
});
...
var GetIntrinsic = __webpack_require__(370);
...
var isPrefixOf = __webpack_require__(402);
var callBound = __webpack_require__(721);
...
const s3_1 = __webpack_require__(35);
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const value = yield s3_1.getOutput(bucket, key, outputName);
    yield util_1.promisify(fs.writeFile)(outputFile, value);
});
...
var getSymbolDescription = __webpack_require__(991);
...
var hasRegExpMatcher = __webpack_require__(132);
...
var $strSlice = __webpack_require__(721)('String.prototype.slice');
...
var getOwnPropertyDescriptors = __webpack_require__(336);
...
var slice = Array.prototype.slice;
var isArgs = __webpack_require__(866);
